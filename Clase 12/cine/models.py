...
class Genre(models.Model):
    name = models.CharField(max_length=64, help_text='Pon el nombre del genero aqui')
...
class Movie(models.Model):
    ...
    summary=models.TextField(max_length=100, help_text='Pon aqui la descripcion de la pelicula')
